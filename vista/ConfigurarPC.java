...
public class ConfigurarPC extends JFrame {
    ...
    private void inicializarVentana() {
        ...
        // Obtenemos datos del controlador
        ...
        for (int i = 0; i < etiquetas.length; i++) {
            ...
            for(Componente c : datos.get(i)) combosComponentes[i].addItem(c);

            // Cualquier cambio llama al controlador para recalcular precio
        ...
        chkMontaje.addActionListener(controller); // Controlador maneja el cambio de precio
    ...
    public void setTextoResumen(String texto) { txtResumen.setText(texto); }
    public void setTextoTotal(String texto) { lblPrecioTotal.setText(texto); }

    // Getters
    public Cliente getClienteActual() { return clienteActual; }
    public JComboBox<Componente>[] getCombosComponentes() { return combosComponentes; }
    public JCheckBox getChkMontaje() { return chkMontaje; }
