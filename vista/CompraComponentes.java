...
public class CompraComponentes extends JFrame {
    ...
    private JButton[] botonesAnadir; // Array para los botones de añadir dinámicos
    private JComboBox<Componente>[] combos; // Array para los combos
    private JSpinner[] spinners; // Array para los spinners
    ...
    public CompraComponentes(Cliente cliente) {
        ...
        // Inicializamos controlador pasando la vista
    ...
    public CompraComponentes(Cliente c, List<LineaPedido> productosPrevios) {
        this(c);
        // Delegamos la carga de datos al controlador
    ...
    private void inicializarVentana() {
        ...
        // Paneles y Scrolls... (código UI estándar resumido)
        ...
        // Arrays para gestionar los componentes dinámicos
        ...
        int yPos = 20;
        // Pedimos al controlador que nos de los datos para rellenar
        ...
        for (int i = 0; i < etiquetas.length; i++) {
            ...
            // Listener visual simple (se queda en vista por simplicidad UI)
            final int index = i;
            ...
            // IMPORTANTE: El comando de acción dice qué índice es
            botonesAnadir[i].setActionCommand(String.valueOf(i)); 
            botonesAnadir[i].addActionListener(controller); // Controlador maneja el click
            panelContenedorItems.add(botonesAnadir[i]);

            yPos += 45; 
        }

        // Resto de UI (Botones estáticos)
    ...
    // Métodos auxiliares para la vista (actualizar UI)
    ...
    public JList<String> getListaVisualCarrito() { return listaVisualCarrito; }
    public JButton getBtnEliminarItem() { return btnEliminarItem; }
    public JButton getBtnFinalizar() { return btnFinalizar; }
    public JButton getBtnVolver() { return btnVolver; }
    public JButton[] getBotonesAnadir() { return botonesAnadir; }
    public JComboBox<Componente> getComboAt(int index) { return combos[index]; }
    public int getCantidadAt(int index) { return (int) spinners[index].getValue(); }
}